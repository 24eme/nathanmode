  	...
  	<table id="rapportCommande" class="tableNm" border="0" width="100%" cellspacing="0" cellpadding="0">
  		...
  		<tbody>
			...
			<tr>
  			...
  			<tr class="statTotal">
  				<td colspan="8"><strong>Total par fournisseur mensuel</strong></td>
  			...
  			<tr class="statTotal ligneMarine">
  				<td colspan="8"><strong>Total N-1 mensuel</strong></td>
  			...
  			<tr class="statTotal ligneJaune">
  				<td colspan="8"><strong>Total N-2 mensuel</strong></td>
			...
			<tr>
  			...
  			<?php 
  					...
  					$total_metrage += round($commande->getMetrage(), 2);
					$total_metrage_all += round($commande->getMetrage(), 2);
