...
abstract class BaseDeviseForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'symbole'        => new sfWidgetFormInputText(),
      'is_pourcentage' => new sfWidgetFormInputCheckbox(),
    ));

    $this->setValidators(array(
      'id'             => new sfValidatorChoice(array('choices' => array($this->getObject()->get('id')), 'empty_value' => $this->getObject()->get('id'), 'required' => false)),
      'libelle'        => new sfValidatorString(array('max_length' => 128)),
      'symbole'        => new sfValidatorString(array('max_length' => 128)),
      'is_pourcentage' => new sfValidatorBoolean(array('required' => false)),
    ));
