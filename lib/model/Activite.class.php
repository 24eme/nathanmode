...
class Activite
{
	...
	public function getMontant($devise = 1, $client = null, $fournisseur = null)
	{
		...
		$reqCredit = "SELECT SUM(b.montant_total) as montant FROM bon b WHERE b.type != 'Facture' AND b.date <= '".$this->to."' AND b.date >= '".$this->from."' AND b.devise_montant_id = ".$devise.$where;
	...
	public function getCom($devise = 1, $client = null, $fournisseur = null)
	{
		...
		$reqCredit = "SELECT SUM(b.total_fournisseur) as montant FROM bon b WHERE b.type != 'Facture' AND b.date <= '".$this->to."' AND b.date >= '".$this->from."' AND b.devise_montant_id = ".$devise.$where;
		$req = "SELECT (".$reqFacture.") as facture, (".$reqCredit.") as credit, (SELECT ifnull(facture,0) - ifnull(credit,0)) as total";
	...
	public function getMts($devise = 1, $client = null, $fournisseur = null)
	{
		...
		$reqCredit = "SELECT SUM(b.metrage) as montant FROM bon b WHERE b.type != 'Facture' AND b.date <= '".$this->to."' AND b.date >= '".$this->from."' AND b.devise_montant_id = ".$devise.$where;
		$req = "SELECT (".$reqFacture.") as facture, (".$reqCredit.") as credit, (SELECT ifnull(facture,0) - ifnull(credit,0)) as total";
	...
	private function getPcs($devise = 1, $client = null, $fournisseur = null, $accessoire = true)
	{
		...
		$reqCredit = "SELECT SUM(b.piece) as montant FROM bon b WHERE b.type != 'Facture' AND b.date <= '".$this->to."' AND b.date >= '".$this->from."' AND b.devise_montant_id = ".$devise.$where;
