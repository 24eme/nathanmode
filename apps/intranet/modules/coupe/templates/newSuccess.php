    ...
    <table id="table_coupe_multiple">
        ...
        <tbody>
            ...
            <tr class="coupe_multiple_ligne" data-line-index="<?php echo $key ;?>" style="opacity: 0.5;">
                ...
                <td style="padding: 4px; padding-left: 0;"><?php echo $formItem['commercial_id']->render(array('style' => 'width: 160px;')); ?><?php echo $formItem['commercial_id']->renderError(); ?></td>
                ...
                <td style="padding: 4px;"><?php echo $formItem['fournisseur_id']->render(array('style' => 'width: 160px;')); ?><?php echo $formItem['fournisseur_id']->renderError(); ?></td>
                <td style="padding: 4px;"><?php echo $formItem['client_id']->render(array('style' => 'width: 160px;')); ?><?php echo $formItem['client_id']->renderError(); ?></td>
                <td style="padding: 4px;"><?php echo $formItem['qualite']->render(array('list' => 'liste_qualite', 'style' => 'width: 160px;', 'autocomplete' => 'off')); ?><?php echo $formItem['qualite']->renderError(); ?></td>
                <td style="padding: 4px;"><?php echo $formItem['colori']->render(array('style' => 'width: 160px;')); ?><?php echo $formItem['colori']->renderError(); ?></td>
                ...
                <td style="padding: 4px;"><?php echo $formItem['situation']->render(array('style' => 'width: 160px;')); ?><?php echo $formItem['situation']->renderError(); ?></td>
