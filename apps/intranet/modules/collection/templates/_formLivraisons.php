<div class="tableau col-8">
    ...
    <div class="px-2">
        <table width="50%" border="0" cellpadding="0" cellspacing="0" class="tabloLivraison">
            <tr>
        ...
        <table width="50%" border="0" cellpadding="0" cellspacing="0" class="tabloLivraison">
            <tr>
              ...
              <tr>
                ...
                <tr>
                    <td><?php echo $form['commande_soldee']->renderLabel() ?>&nbsp;:</td>
                    <td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="150"><?php echo $form['observation_livraison']->renderLabel() ?> :</td>
            <td>
