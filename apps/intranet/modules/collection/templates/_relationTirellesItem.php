<tr class="relation_item_form">
    <td>
        <?php echo $form['date_expedition']->render(); ?>
    ...
    <td>
        <?php echo $form['bain']->render(); ?>
        <?php echo $form['bain']->renderError(); ?>
    </td>
    <td>
        <?php echo $form['date_validation']->render(); ?>
        <?php echo $form['date_validation']->renderError(); ?>
    </td>
    <td>
        <?php echo $form['date_refusation']->render(); ?>
        <?php echo $form['date_refusation']->renderError(); ?>
    </td>
    <td>
        <?php echo $form['date_retraitement']->render(); ?>
