...
<a class="btn btn-light btn-sm float-end mb-2 ms-1" style="text-decoration: none;" href="<?php echo url_for('activiteGraph') ?>"><i class="bi bi-graph-up"></i> Graphique du CA</a>
</div>
