<div id="containerCA" class="container">
	...
	<?php include_partial('activite/breadcrumb', array('commercial' => ($comFiltered)? $comFiltered : $commercial, 'client' => $client, 'fournisseur' => $fournisseur, 'parameters' => $parameters, 'devise' => $devise, 'tous' => true, 'type' => $type)); ?>
